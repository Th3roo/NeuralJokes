...
BOT_JOKE_GENERATION__MAX_RETRIES = int(os.getenv("BOT_JOKE_GENERATION__MAX_RETRIES"))
BOT_JOKE_GENERATION__STREAMING_DELAY = float(os.getenv("BOT_JOKE_GENERATION__STREAMING_DELAY"))
